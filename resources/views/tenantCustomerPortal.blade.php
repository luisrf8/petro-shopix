...
<head>
  ...
  <title>{{ $tenant->name }} - Mi cuenta</title>
  ...
  <style>
    ...
    body {
      background:
        radial-gradient(circle at 8% 12%, rgba(var(--tenant-primary-rgb), 0.08), transparent 35%),
        radial-gradient(circle at 90% 88%, rgba(var(--tenant-primary-rgb), 0.08), transparent 30%),
        #f4f6fb;
      min-height: 100vh;
    }
    ...
    .portal-anchor-btn.active {
      ...
      border-color: rgba(var(--tenant-primary-rgb), 0.24);
      color: #0f172a;
    }
  ...
  <script>
    (() => {
      ...
      logoutBtn.addEventListener('click', () => {
        clearSession();
        window.location.href = '{{ $tenantLandingUrl }}';
      });
